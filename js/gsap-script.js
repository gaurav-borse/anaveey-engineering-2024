...
$(document).ready(function () {
    ...
    var _tl = gsap.timeline({ onStart: playBoxes })
        ...
        // .set('.mainBoxes', { left: '70%', xPercent: -50, width: 1200, rotationX: 0, rotationY: 0, rotationZ: 0 })
        .set('.mainBoxes', { left: '73%', xPercent: -50, width: 1200, rotationX: 9, rotationY: -7, rotationZ: 8 })
